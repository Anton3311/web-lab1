...
public class DataImportExportTests {
    ...
    public void exportToCsv() {
        ...
        sessions.add(new Session("Movie 1", 100, 3));
        sessions.add(new Session("Movie 2", 200, 3));
        sessions.add(new Session("Movie 3", 150, 3));

        when(cinema.getSessions()).thenReturn(sessions);

        // MovieName;Duration;NumberOfTickets;AvailableSeats;
        // Movie 1;100;3;[0, 1, 2];
        // Movie 2;200;3;[0, 1, 2];
        // Movie 3;150;3;[0, 1, 2];
    ...
    public void importFromCsv() {
        ...
        expectedMovies.add(new Session("Movie 1", 100, 3));
        expectedMovies.add(new Session("Movie 2", 200, 3));
        expectedMovies.add(new Session("Movie 3", 150, 3));
